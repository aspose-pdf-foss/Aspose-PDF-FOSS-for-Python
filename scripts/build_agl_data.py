...
in ``fontTools.agl.LEGACY_AGL2UV`` (4281 names). fontTools is a build-time
dependency only: the runtime library never imports it and loads only the
generated blob below. The output is deterministic and no network is used.
...
def build_bundle() -> bytes:
    ...
    payload = {
        ...
        # Expert/MacExpert are intentionally omitted (rare; no reliable source).
        "encodings": {
